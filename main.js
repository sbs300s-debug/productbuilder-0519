...
const movieData = {
    ...
    scared: [
        { title: { ko: "컨저링", en: "The Conjuring" }, desc: { ko: "무서운 장면 없이 무서운 실화 바탕 공포물. 심리적인 압박감과 보이지 않는 존재의 공포가 압권입니다.", en: "A horror film based on a true story that's scary without gore. The psychological pressure and the fear of an invisible existence are the masterpieces." }, img: "https://images.unsplash.com/photo-1505633560063-d8244f03a3d3?q=80&w=500&auto=format&fit=crop" },
        { title: { ko: "겟 아웃", en: "Get Out" }, desc: { ko: "숨 막히는 긴장감과 소름 돋는 반전. 단순한 공포를 넘어 사회적인 메시지를 담은 미스터리 스릴러.", en: "Breathtaking tension and spine-chilling twists. A mystery thriller containing social messages beyond simple horror." }, img: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=500&auto=format&fit=crop" },
        { title: { ko: "유전", en: "Hereditary" }, desc: { ko: "가족의 비극에서 시작된 벗어날 수 없는 공포. 가문의 저주와 기이한 현상들이 숨통을 조여옵니다.", en: "An inescapable horror that begins with a family tragedy. The family curse and strange phenomena choke you." }, img: "https://images.unsplash.com/photo-1509248961158-e54f6934749c?q=80&w=500&auto=format&fit=crop" },
