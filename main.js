...
const movieData = {
    happy: [
        ...
        { title: { ko: "라라랜드", en: "La La Land" }, desc: { ko: "꿈꾸는 사람들을 위한 별들의 도시, 마법 같은 음악 영화", en: "A city of stars for dreamers, a magical musical film." }, emoji: "💃" }
    ],
    sad: [
        ...
        { title: { ko: "코코", en: "Coco" }, desc: { ko: "가족의 의미를 되새기게 하는 감동적인 사후 세계 여행", en: "A moving journey through the afterlife that reminds us of the meaning of family." }, emoji: "💀" }
    ],
    excited: [
        ...
        { title: { ko: "분노의 질주: 더 익스트림", en: "The Fate of the Furious" }, desc: { ko: "압도적인 스케일의 카체이싱 액션", en: "Car chasing action on an overwhelming scale." }, emoji: "🚗" }
    ],
    scared: [
        ...
        { title: { ko: "유전", en: "Hereditary" }, desc: { ko: "가족의 비극에서 시작된 벗어날 수 없는 공포", en: "An inescapable horror that begins with a family tragedy." }, emoji: "🏠" }
    ],
    calm: [
        ...
        { title: { ko: "카모메 식당", en: "Kamome Diner" }, desc: { ko: "핀란드에서 열린 작은 식당의 소박하고 따뜻한 이야기", en: "A simple and warm story of a small restaurant in Finland." }, emoji: "🍙" }
    ]
};
