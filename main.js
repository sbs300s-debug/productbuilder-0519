...
const movieData = {
    ...
    scared: [
        { title: { ko: "컨저링", en: "The Conjuring" }, desc: { ko: "무서운 장면 없이 무서운 실화 바탕 공포물. 심리적인 압박감과 보이지 않는 존재의 공포가 압권입니다.", en: "A horror film based on a true story that's scary without gore. The psychological pressure and the fear of an invisible existence are the masterpieces." }, img: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?q=80&w=500&auto=format&fit=crop" },
        { title: { ko: "겟 아웃", en: "Get Out" }, desc: { ko: "숨 막히는 긴장감과 소름 돋는 반전. 단순한 공포를 넘어 사회적인 메시지를 담은 미스터리 스릴러.", en: "Breathtaking tension and spine-chilling twists. A mystery thriller containing social messages beyond simple horror." }, img: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=500&auto=format&fit=crop" },
        ...
        { title: { ko: "미드소마", en: "Midsommar" }, desc: { ko: "밝은 태양 아래서 벌어지는 기괴한 축제. 낮이 주는 공포라는 독특한 분위기의 호러 영화입니다.", en: "A bizarre festival held under the bright sun. A horror movie with a unique atmosphere called fear given by day." }, img: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?q=80&w=500&auto=format&fit=crop" },
